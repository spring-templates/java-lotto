...
public enum ExceptionStatus {
    ...
    IllegalLottoDuplicationException("[ERROR] 당첨 번호는 중복이 없을 때 입력할 수 있어요."),
    IllegalLottoSizeException("[ERROR] 당첨 번호는 6개 숫자를 입력할 수 있어요."),
    IllegalLottoScopeException("[ERROR] 당첨 번호는 1에서 45 사이 숫자를 입력할 수 있어요."),
